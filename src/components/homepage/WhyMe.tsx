...
export default function WhyMe() {
    return (
        ...
        <SectionTitle title="Why Me ?" subtitle="Special About me"/>
        <div className="pt-12">
            <div className="mx-auto px-6 max-w-6xl text-gray-500">
                <div className="relative">
                    <div className="relative z-10 grid gap-3 grid-cols-6">
                        <div className="col-span-full lg:col-span-2 overflow-hidden flex relative p-10 rounded-xl bg-white border border-slate-200 ">
                            <div className="size-fit m-auto relative">
                                <div className="relative h-24 w-56 flex items-center">
                                    ...
                                    <span className="w-fit block mx-auto text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-br from-blue-300 to-blue-600  ">
                                        100%
                                    </span>
                                </div>
                                <h2 className="mt-6 text-center font-semibold text-slate-800  text-3xl">
                                    Tailored <br /> Solutions
                                </h2>
                            </div>
                        </div>
                        <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-10 rounded-xl bg-white border border-slate-200 ">
                            <div>
                                <div className="relative aspect-square rounded-full size-32 flex border mx-auto   before:absolute before:-inset-2 before:border   before:rounded-full">
                                    <svg
                                ...
                                <div className="mt-6 text-center relative z-10 space-y-2">
                                    ...
                                    Trust in secure and ethical practices. I ensure your social media accounts are protected with the highest standards.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-10 rounded-xl bg-white border border-slate-200 ">
                            <div>
                                ...
                                <div className="mt-14 text-center relative z-10 space-y-2">
                                    ...
                                    <p className=" text-gray-700">
                                    Watch your YouTube and Instagram presence grow rapidly with my expertise. I deliver results quicker than you can imagine.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-full lg:col-span-3 overflow-hidden relative p-10 rounded-xl bg-white border border-slate-200 ">
                            <div className="grid sm:grid-cols-2">
                                <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className=" text-gray-700">
                                        Stay ahead with cutting-edge strategies and tools. I continually update my methods to provide the best service possible for your social media needs.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="h-full grid sm:grid-cols-2">
                                <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className=" text-gray-700">
                                        Gain insights with detailed analytics and reports to understand your audience better and refine your strategies effectively.
                                        </p>
                                    </div>
                                </div>
                                <div className="mt-6 relative sm:-mr-10 sm:-my-10 before:absolute before:w-px before:inset-0 before:mx-auto before:bg-slate-200">
                                        ...
                                        <div className="flex items-center justify-end gap-2 w-[calc(50%+0.875rem)] relative">
                                            ...
                                            <div className="size-7 ring-4 ring-white ">
                                                <Image
                                                    ...
                                                    src="/images/personal/camera.jpeg"
                                                    alt="AttaXpert"
                                                />
                                            </div>
                                        </div>
